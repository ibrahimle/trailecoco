...
class GameScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GameWidget(
        game: EcoTrailGame(
          playerProgress: Provider.of<PlayerProgressProvider>(context, listen: false),
        ),
        ...
        overlayBuilderMap: {
          ...
          'LevelComplete': (context, EcoTrailGame game) => LevelComplete(game: game),
          ...
          'PrivacyPolicy': (context, EcoTrailGame game) => PrivacyPolicy(game: game),
          'Shop': (context, EcoTrailGame game) => Shop(game: game),
          'LevelSelect': (context, EcoTrailGame game) => LevelSelect(game: game),
        },
      ),
    );
  }
